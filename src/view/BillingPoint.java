...
*/
    ...
    private void Total_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Total_btnActionPerformed
        for(int i =0;i<=tbl_Bill.getRowCount();i++){
            DefaultTableModel dtm = (DefaultTableModel) tbl_Bill.getModel();
                ...
                int columnTotal= 4;
                String fetchedTotal = dtm.getValueAt(i, columnTotal).toString();
                System.out.printf(fetchedTotal);
        }
    ...
    private void btnFilterActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnFilterActionPerformed
        ...
        try {
            ...
            while (result.next()) {
                ...
                model.addRow(new Object[] { prodId, prodName, prodQty, prodPrice, prodCategory });// TODO add your
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillingPoint.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
